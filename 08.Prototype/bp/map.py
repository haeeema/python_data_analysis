...
def station():
    if request.method == 'GET':
        ...
        stations = [station for station in stations if len(
            station.strip()) != 0]
        # static/img/station_map.html 파일
        mu.get_station_map(current_app.root_path, stations)
